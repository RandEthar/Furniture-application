...
List<FurnitureModel> productList=[
 FurnitureModel(
  ...
  price: 230.00,
  oldPrice: 512.58,
  imageUrl: "asset/images/item1.png",
  rating: 4.9,
  reviews: 256,
...
FurnitureModel(
  ...
  price: 274.13,
  oldPrice: 856.60,
  imageUrl: "asset/images/item2.png",
  rating: 4.8,
  reviews: 128,
...
FurnitureModel(
  ...
  price: 24.99,
  oldPrice: 69.99,
  imageUrl: "asset/images/item3.png",
  rating: 4.9,
  reviews: 256,
...
FurnitureModel(
  ...
  price: 50.99,
  oldPrice: 69.99,
  imageUrl: "asset/images/item4.png",
  rating: 4.9,
  reviews: 256,
 ...
 FurnitureModel(
  ...
  price: 230.00,
  oldPrice: 512.58,
  imageUrl: "asset/images/item7.png",
  rating: 4.9,
  reviews: 256,
  description: "A minimalist chair with a reversible back cushion provides soft support for your back and has two sides to wear."
 ,discount: 45,
...
FurnitureModel(
  ...
  price: 50.99,
  oldPrice: 69.99,
  imageUrl: "asset/images/item6.png",
  rating: 4.9,
  reviews: 256,
  description: "A sleek and practical bedside table with a spacious drawer, offering easy storage and a minimalist design.",
  discount: 45,
